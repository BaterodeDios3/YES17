...
#################################################################################
{
    ...
    "summary":  """Provide access to a single specific POS to the user using the is module. Once restricted, the user can see and use only his designated POS in Odoo.Default User|Default|User|Custom User""",
